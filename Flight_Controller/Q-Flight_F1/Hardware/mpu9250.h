...
#define CALC_STD_ARRAY_SIZE 20
#define MEAN_ARRAY_SIZE 10
...
extern void MPU9250_AccRead(int16_t *accData);
extern void MPU9250_GyroRead(int16_t *gyroData);
extern void MPU9250_MagRead(int16_t *magData);
extern void MPU9250_TempRead(float *tempdata);
extern void MPU9250_Init(void);
extern void MPU9250_CalcGyroOffset(void);
